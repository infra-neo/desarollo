...
import { Activity, LogOut, X, FileJson, Boxes, Cloud, MonitorSmartphone } from "lucide-react";
...
const Sidebar = ({ isMobileOpen, setIsMobileOpen }: Props) => {
  ...
  const menuItems = [
    ...
    { icon: Cloud, label: "Multi-Cloud", path: "/clouds", count: null },
    { icon: Boxes, label: "Workspace", path: "/workspace", count: null },
    { icon: MonitorSmartphone, label: "Remote Access", path: "/remote", count: null },
